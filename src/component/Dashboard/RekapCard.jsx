        ...
        <div className="w-full p-5 bg-white rounded-xl border-2 border-grey flex-col gap-2 justify-between inline-flex">
            ...
            {isModalOpen && (
                <div className="fixed inset-0 flex items-center justify-center z-50">
                    ...
                    />
                    <div
                        className="w-1/4 p-5 bg-white rounded-[20px] flex-col justify-start items-start gap-2.5 inline-flex z-10">
                        <div
                            className="self-stretch max-h-[80vh] overflow-y-auto flex-col justify-start items-start gap-2.5 flex">
                            ...
                            <div className="self-stretch h-[559px] flex-col justify-start items-start gap-5 flex">
                                ...
                                <div className="self-stretch h-[103px] flex-col justify-start items-start flex">
                                    ...
                                    <div
                                        className="self-stretch text-gray-600 text-sm font-normal font-poppins leading-snug">
