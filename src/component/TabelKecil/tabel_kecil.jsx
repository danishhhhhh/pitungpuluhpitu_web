        ...
        <div className="grid grid-rows-1 ">
            ...
            {isEditModalOpen && (
                <div className="fixed inset-0 flex items-center justify-center z-50">
                    ...
                    <div className="w-[500px] h-[300px] px-[35px] py-[45px] bg-white rounded-[15px] shadow-lg flex-col justify-center items-center gap-[30px] inline-flex relative z-10">
                        <div className="text-center text-zinc-900 text-2xl font-semibold font-['Poppins'] leading-9">Edit Mekanik</div>
                        <div className="self-stretch h-[150px] flex-col justify-center items-center gap-5 flex">
                            <div className="self-stretch h-[76px] flex-col justify-start items-start gap-[5px] flex">
                                <div className="text-center text-black text-sm font-medium font-['Poppins']">Nama Mekanik</div>
            ...
            {isDeleteModalOpen && (
                <div className="fixed inset-0 flex items-center justify-center z-50">
                    ...
                    <div className="w-[400px] h-[200px] px-[35px] py-[45px] bg-white rounded-[15px] shadow-lg flex-col justify-center items-center gap-[30px] inline-flex relative z-10">
                        <div className="text-center text-zinc-900 text-2xl font-semibold font-['Poppins'] leading-9">Konfirmasi Hapus</div>
                        <div className="text-center text-black text-sm font-medium font-['Poppins']">
                            Apakah Anda yakin ingin menghapus mekanik ini?
                        </div>
                        <div className="self-stretch h-[51px] p-2.5 bg-red rounded-[15px] flex-col justify-center items-center gap-2.5 flex">
                            <button
                                type="button"
            ...
            {isTambahModalOpen && (
                <div className="fixed inset-0 flex items-center justify-center z-50">
                    ...
                    <div className="w-[500px] h-[300px] px-[35px] py-[45px] bg-white rounded-[15px] shadow-lg flex-col justify-center items-center gap-[30px] inline-flex relative z-10">
                        <div className="text-center text-zinc-900 text-2xl font-semibold font-['Poppins'] leading-9">Tambah Mekanik</div>
                        <div className="self-stretch h-[76px] flex-col justify-start items-start gap-[5px] flex">
                            <div className="text-center text-black text-sm font-medium font-['Poppins']">Nama Mekanik</div>
                            <div className="self-stretch px-[15px] py-4 bg-white rounded-[15px] border border-zinc-200 justify-start items-center gap-2.5 inline-flex">
                                <input
