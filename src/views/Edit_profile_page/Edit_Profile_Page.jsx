...
const EditProfilePage = () => {
  ...
  return (
    <div className="flex">
      <Sidebar />
      <Navbar data="Edit" />
      <div className="w-[1614px] h-[999.85px] pt-20 px-2 flex-col justify-start items-start gap-[30px] inline-flex">
        <div className="flex-col justify-start items-start gap-[5px] flex">
          <div className="text-slate-800 text-2xl font-semibold font-['Poppins'] leading-7">Profil</div>
          <div className="text-gray-600 text-base font-normal font-['Poppins'] leading-7">Perbarui detail foto dan nama anda di sini.</div>
        </div>
        ...
        <div className="flex-col justify-start items-start gap-5 flex">
          <div className="justify-start items-start gap-5 inline-flex">
            ...
            <div className="py-2.5 flex-col justify-start items-start gap-[15px] inline-flex">
              <div className="text-slate-800 text-xl font-semibold font-['Poppins'] leading-7">Foto Profil</div>
              <div className="flex-col justify-start items-start gap-[5px] flex">
                <div className="justify-start items-start gap-[5px] inline-flex">
                  <label className="px-2.5 py-1 bg-yellow rounded-[10px] justify-center items-center gap-[5px] flex cursor-pointer">
                    ...
                    <div className="text-bluegrey text-xs font-normal font-['Poppins'] leading-7">Upload Gambar</div>
                  ...
                  >
                    <div className="text-red text-xs font-normal font-['Poppins'] leading-7">Hapus Gambar</div>
                  </button>
                </div>
                <div className="text-grey text-xs font-normal font-['Poppins'] leading-7">Kami mendukung PNG dan JPG di bawah 10mb.</div>
              </div>
            </div>
          </div>
          <div className="flex-col justify-center items-center gap-2.5 flex">
            <div className="self-stretch h-[78px] flex-col justify-start items-start gap-[5px] flex">
              <div className="text-center text-gray-800 text-sm font-medium font-['Poppins']">Nama Admin</div>
              <input
                type="text"
                value={adminName}
        ...
        <div className="justify-start items-start gap-2.5 inline-flex">
          <button className="px-[15px] py-[5px] bg-yellow rounded-[10px] justify-center items-center gap-[5px] flex">
            <div className="text-bluegrey text-sm font-normal font-['Poppins'] leading-7">Simpan Perubahan</div>
          </button>
          <button className="px-[15px] py-[5px] bg-white rounded-[10px] border-2 border-red justify-center items-center gap-[5px] flex">
            <div className="text-red text-sm font-normal font-['Poppins'] leading-7">Batalkan</div>
          </button>
        </div>
      </div>
    </div>
